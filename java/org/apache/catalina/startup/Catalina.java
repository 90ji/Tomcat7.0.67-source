...
public class Catalina {
    ...
    public void load() {
        ...
        initDirs();//初始化目录,加载home这个目录

        // Before digester - it may be needed

        initNaming();//设置一些系统常量,一些类的地址URL_PKG_PREFIXES和INITIAL_CONTEXT_FACTORY

        // Create and execute our Digester
        Digester digester = createStartDigester();//初始化Digester组件，定义了解析规则
        ...
        try {
            ...
            try {
                ...
                digester.push(this);
                digester.parse(inputSource);//通过Digester解析这个文件，在此过程中会初始化各个组件实例及其依赖关系.最后会把server.xml文件中的内容解析到StandardServer中
    ...
    protected void initDirs() {
        ...
        String catalinaHome = System.getProperty(Globals.CATALINA_HOME_PROP);//获取home目录
